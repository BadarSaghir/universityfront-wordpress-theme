  ...
  <div class="full-width-split group">
      ...
      <div class="full-width-split__inner">
        ...
        <div class="event-summary">
          ...
          <div class="event-summary__content">
            ...
            <p><?php echo wp_trim_words(get_the_excerpt(),10);wp_reset_postdata()?> <a href="<?php echo the_permalink()?>" class="nu gray">Learn more</a></p>
          </div>
        </div>
            <?php }?>
        <!-- <div class="event-summary">
    ...
    <div class="full-width-split__two">
      <div class="full-width-split__inner">
        ...
        $homepage_query= new WP_Query(array("posts_per_page"=>2));
        ...
        <div class="event-summary">
          ...
          <div class="event-summary__content">
            <h5 class="event-summary__title headline headline--tiny"><a href="<?php echo the_permalink()?>"><?php echo get_the_title()?></a></h5>
            <p><?php echo wp_trim_words(get_the_excerpt(),10);wp_reset_postdata()?> <a href="<?php echo the_permalink()?>" class="nu gray">Read more</a></p>
          </div>
        </div>
